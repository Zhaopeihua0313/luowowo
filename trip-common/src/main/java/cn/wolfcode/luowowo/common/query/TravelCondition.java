...
public class TravelCondition {
    ...
    static {
        ...
        TRAVEL_DAYS.put(5, new TravelCondition(2, 3));
        TRAVEL_DAYS.put(6, new TravelCondition(4, 5));
        TRAVEL_DAYS.put(7, new TravelCondition(6, 9));
        TRAVEL_DAYS.put(8, new TravelCondition(10, null));
    }
