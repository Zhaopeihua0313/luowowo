    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $('#zhankai').on('click', function () {
                $('.restrictheight').css("height", "300px!important");
            })
        })
    </script>
...
<div class="wrapper">
    ...
    <form class="form-hotel" action="/hotel/query" method="get" id="editForm">
    <div class="hotel-searchbar clearfix">
        <div class="hs-item hs-item-search" id="_j_hotel_search">
            <input type="text" value="${dest.name!}" id="_j_search_input" autocomplete="off" name="keyword">
            <div class="hotel-suggest simsun" id="_j_search_suggest" style="display:none;"></div>
        </div>
        <#--按钮-->
        <div class="btn-search" id="_A_search_btn">
            <button type="submit" style="width: 114; height: 34px; background: #ffa800; color: #fff;">搜索
            </button>
        </div>
    </div>
    </form>
    ...
    <div class="area-main clearfix">
        <div class="area-wrapper" id="_j_area_wrapper" style="">
            <dl class="item-area clearfix _j_area_list">
                <dt>区域:</dt>
                <dd>
                    <ul class="area-nav clearfix restrictheight" style="height: 80px!important;">
                        <li><a href="javascript:;" class="_j_area_name on" data-id="-1">全部</a></li>
                        <#list son as s>
                            <li>
                                <a href="/hotel/query?destId=${s.id}" class="_j_area_name" data-id="${s.id}">${s.name}</a>
                            </li>
                        </#list>
                    </ul>
                </dd>
                ...
                <dd>
                    <ul class="area-nav clearfix">
                        <#list brothers as b>
                            <li>
                                <a href="/hotel/query?destId=${b.id}" target="_blank" >${b.name}</a>
                            </li>
                        </#list>
                    </ul>
                </dd>
    ...
    <div class="container">
        ...
        <div class="hotel-toolbar clearfix">
            <div class="htb-item htb-item-dropdown" id="_j_facility_filter">
                <div class="htb-title">主题分类</div>
                <select name="tagId" class="form-control" id="tagId">
                ...
                <script>
                    $("#tagId option[value='${qo.tagId!}']").prop("selected", true);
                </script>
            </div>
            <div class="htb-item htb-item-dropdown" id="_j_star_filter">
                ...
                <select name="level" class="form-control" id="level">
                    ...
                    <option value="4">奢华</option>
                </select>
                <script>
                    $("#level option[value='${qo.level!}']").prop("selected", true);
                </script>
            </div>
            <div class="htb-item htb-item-dropdown" id="_j_type_filter">
                ...
                <select name="type" class="form-control" id="type">
                    <option value="-1">全部</option>
                    <option value="1">度假村</option>
                    <option value="2">连锁</option>
                    <option value="3">公寓</option>
                    <option value="4">民宿</option>
                </select>
                <script>
                    $("#type option[value='${qo.type!}']").prop("selected", true);
                </script>
            </div>
            <div class="htb-item htb-item-dropdown" id="_j_type_filter">
                <div class="htb-title">排序</div>
                <select name="ordertype" class="form-control" id="orderby">
                    <option value="-1">默认</option>
                    <option value="1">价格升序</option>
                    <option value="2">价格降序</option>
                </select>
                <script>
                    $("#orderby option[value='${qo.ordertype!}']").prop("selected", true);
                </script>
            </div>
            <#--按钮-->
            <div class="btn-search" id="_A_search_btn" style="padding-top: 19px;">
                <button type="submit" style="width: 114; height: 34px; background: #ffa800; color: #fff;">搜索
            </div>
        </div>
        </form>
        <div class="n-content" id="hotelcontent">
                ...
                <div class="hotel-item clearfix _j_hotel_item" data-id="9031088" data-is-merge_room="0"
                    ...
                    <div class="hotel-pic">
                        <a href="${h.url}" class="_j_hotel_info_link" target="_blank"
                           data-cs-p="图片">
                            <img src="/${h.coverUrl}"
                                 alt="" style="height: 230px; width: 230px;">
                        </a>
                    ...
                    <div class="hotel-info ">
                        <ul class="nums clearfix">
                            ...
                            <li class="split">非常好</li>
                        </ul>

                        <div class="location">
                            <span><i class="icon-location"></i>详细地址: <a href="javascript:;" data-id="1762"
                                                                      data-type="area">${h.adress}</a></span>
                        </div>
                        <div class="location">
                            <span><i class="icon-location"></i>简介: <a href="${h.url}" data-id="1762"
                                                                        data-type="area">${h.intro}</a></span>
                        </div>

                    </div>
                    <div class="hotel-btns">
                        <a class="btn-booking _j_booking_btn" href="${h.url}" rel="nofollow" style=""
                           data-ota="ctrip"
                           data-url=""
                           data-price="626" data-is-cache-price="0" data-is-sold-out="0" data-pay-type="">
                            ...
                            <div class="price _j_booking_price" style="float: left;
    padding-right: 41px;
    width: 230px;
    ...
    position: relative;">
                                <strong>￥</strong><strong>${h.salePrice}</strong><strong
        ...
        <script language="javascript" src="http://js.mafenvogwo.net/js/jquery-ui-1.11.0.min.js?1537192880"
                type="text/javascript" crossorigin="anonymous"></script>
