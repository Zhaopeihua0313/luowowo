...
<head>
    ...
    <script>
        $(function () {
            ...
            $("#_j_index_search_tab li").on('click', function () {
                var val = $(this).data("index");
                $("#searchType").val(val);
            })

            //dialogCommon("OK", 1000000, 'no');
        })
    </script>
...
<body>
    ...
    <div class="mfw-focus" id="_j_mfw_focus">
        <div class="show-slider" style="height: 450px;">
                ...
                <#list tcs! as tc>
                    <li class="${(tc_index==0)?string('first','')}">
                        <a href="/travel/detail?id=${tc.travelId!}" class="show-pic">
                            <img src="${tc.coverUrl!}" style="height: 450px;">
                        </a>
                        <a href="javascript:;" class="show-title dark">
                            <div class="date">
                                <#--关联游记的出行日期-->
                                <span class="day">${tc.travel.releaseTime?string('d号')}</span>/${tc.travel.releaseTime?string('M月 yyyy')}
                            </div>
                            <h3>${tc.title!}</h3>
                        </a>
                    </li>
            ...
            <a class="show-more" target="_blank" href="/strategy">历历在目</a>
        </div>
        <#--搜索栏-->
    ...
    <div class="mfw-container clearfix">
        ...
        <div class="sales-entrys-container clearfix">
            ...
            <a class="sales-entrys-item entrys-bg-group" href="/ticket">
                <div class="sales-entrys-title">
                    跟团游
                </div>
                <div class="sales-entrys-subtitle">
                ...
                <div class="asidebox-bd">
                    ...
                    <#list scs! as sc>
                        <div class="gonglve-item">
                            <div class="img">
                                <a href="/strategy/detail?id=${sc.detailId}" target="_blank">
