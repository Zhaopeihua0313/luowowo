        ...
        <div class="wid clearfix">
            ...
            <div class="flt1 ser-lt" id="_j_search_result_left">
                ...
                <div class="_j_search_section">
                    <div class="att-list">
                        <div class="clearfix ser-title">
                            <h2>
                                <a href="/strategy/list?destId=${dest.id!}"  class="" data-index="1">${dest.name!}攻略</a>
                            </h2>
                            <a href="/strategy/list?destId=${dest.id!}"  class="" data-index="1">查看更多攻略
                                &gt;&gt;</a>
                        </div>
                        <ul>
                            <li>
                                <div class="clearfix">
                                    ...
                                    <div class="ct-text ">
                                        ...
                                        <ul class="seg-info-list clearfix">
                                            <li>
                                                <a href="/strategy/list?destId=${dest.id!}"  class="">${s.provinceName!}-${s.destName!}</a>
                                            </li>
                                            <li>
                                                浏览(${s.viewnum!0})
                                            </li>
                ...
                <div class="travel-notes _j_search_section" data-category="info">
                    <div class="clearfix ser-title">
                        <h2>
                            <a href="/destination/guide?id=${dest.id!}"  class="" data-index="2">${dest.name!}游记</a>
                        </h2>
            ...
            <#if dest??>
                <div class="flt1 ser-rt">
                    <div class="_j_search_section" data-category="poi">
                        <div class="clearfix ser-title">
                            <h2>
                                <a href="javascript:;"  class="_j_search_link">${dest.name!}附近热门景点</a>
                            </h2>
                            <a href="javascript:;"  class="_j_search_link">全部${dest.name!}景点 &gt;&gt;</a>
                        </div>
                        <div class="hot-att">
                            <ul class="clearfix">
                                <li>
