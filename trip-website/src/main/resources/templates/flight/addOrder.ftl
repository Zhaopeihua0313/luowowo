...
<head>
    ...
    <title>欢迎下单：机票 航班号 ${flightInfo.flightNo}</title>
...
<div class="mainBox">
    ...
    <div class="wrap">
        ...
        <div class="orderTicket clearfix">
            <!--订单明细-->
            <div class="orderInfo orderFlightInfo" style="top: 139px;left: 1241.5px;">
                <div class="orderFlightInfo-list" style="padding: 10px 15px 5px;">
                    <h3 style="font-size: 18px;
                        font-weight: normal;">费用明细</h3>
                    <ul class="nobd" style="padding: 10px 0;">
                        <li class="primary" style="height: 28px;
                                line-height: 28px;
                                ">
                            <em>航班价格</em>
                            <dfn ><i>￥</i>${(flightInfo.price)!}</dfn>
                        </li>
                        <li style="height: 28px;
                                    line-height: 28px;
                                    ">
                            <em>航班 ${(flightInfo.flightNo)!}</em>
                            <dfn class="dark" style="text-align: right;">
                                <span class="f12">1 X <i>￥</i></span>${(flightInfo.price)!}</dfn>
                        </li>
                    </ul>
                    <ul class="last" style="padding: 10px 0;
                            border-top: 1px dotted #fc6;"></ul>
                </div>
                <div class="ticketPriceTotal">
                    <em>应付金额</em>
                    <div class="priceCount">
                        <dfn><span class="yh">￥</span>${(flightInfo.price)!}</dfn>
                    </div>
                </div>
            </div><!-- //orderInfo -->
                    ...
                    <form method="POST" action="/order/createOrder" name="orderForm" id="orderForm" autocomplete="smartystreets">
                        ...
                        <div class="orderBox">
                            <div class="orderTit">
                                ...
                                <#--顶部商品名-->
                                <h3>航班 ${flightInfo.flightNo}：${(flightInfo.leaveCity)!} 到 ${(flightInfo.arriveCity)!}</h3>
                            ...
                            <div class="ticketLi last main">
                                <div class="ticketTit">
                                    <#--航班往返信息-->
                                    <a href="javascript:;" class="ticketTit-link" >
                                    [${flightInfo.leavePort}]    <span style="color: #1ec896;font-size: 12px;padding: 46px;" >飞往</span>    [${flightInfo.arrivePort}]
                                    </a>
                                    <br>
                                    <#--<a href="javascript:;" class="ticketTit-link" >
                                        <span style="color: #1ec896">${flightInfo.tkTime}</span>    ----    <span style="color: #1ec896">${flightInfo.arTime}</span>
                                        <span class="icon_arrownew"><i>◆</i><b>◆</b></span>
                                    </a>-->
                                    <#list flightInfo.tagss! as tag>
                                        <span class="tagsback">
                                            <i>${tag.name}</i>
                                        </span>
                                    </#list>
                        ...
                        <div class="orderBox order_box" style="padding: 0 0px 40px;">
                            ...
                            <div id="userinfoDiv"><div class="ticketInput" id="Jtenantlist">
                                <div class="ticketGroup">
                                    <#--产品名： 如门票-->
                                    <h3 class="ticketInput-ticTit">
                                        <span style="color: #ff0a5c">${(flightInfo.flightNo)!}航班</span>
                                        ${(flightInfo.tkTime)!} 从 ${(flightInfo.leaveCity)!} 到 ${(flightInfo.arriveCity)!} ${(flightInfo.arTime)!}
                                    </h3>
                                    <#--订单产品 门票id ！！！！！！！！！！！！！！！！！！！！！！-->
                                    <input type="hidden" name="orderProductId" id="orderProductId"
                                           value="${(flightInfo.flightNo)!}航班 ${(flightInfo.tkTime)!} ${(flightInfo.leaveCity)!} 到 ${(flightInfo.arriveCity)!} ${(flightInfo.arTime)!}">
                                    <#--订单产品 类型 机票  ！！！！！！！！！！！！！！！！！！！！！！-->
                                    ...
                                    <div class="playerLi">
                                        <div class="user_info border_t1_dotted" index="0">
                                            <p class="orderUser">
                                                <em>乘客 1</em> <span class="tagPink JS_pinkTip" style="height: 13px;" >取票人</span>
                                            ...
                                            <dl class="orderDl js_user_dl">
                                                ...
                                                <dd>
                                                    ...
                                                    <input class="input js_yz js_textBig"  id="orderUserCardNumber" style="height: 15px;"
                                                           ...
                                                           placeholder="证件号码">
                                                    <span class="ts_text">该证件为登机凭证或购买保险凭证，请准确填写。</span>
            ...
            $.get("/order/createOrder",
                    {
                        ...
                        orderProductName:"[${(flightInfo.flightNo)!}]航班号 ${(flightInfo.tkTime)!} ${(flightInfo.leaveCity)!} 飞往 ${(flightInfo.arriveCity)!} ${(flightInfo.arTime)!}",
                        orderUserName:orderUserName,
                        orderUserPhone:orderUserPhone,
                        orderUserCardNumber:orderUserCardNumber,
                        orderRealPrice:${flightInfo.price},
