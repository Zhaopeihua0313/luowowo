...
public class LoginController {
    ...
    @ResponseBody
    public AjaxResult userLogout(HttpServletRequest request, HttpServletResponse response,
                                 HttpSession session, @LoginUser UserInfo userInfo) {
    ...
    public String wxcallback(String code, String state,
        ...
        if (state != null && state.equals("ytrlww") && code != null) {
            ...
            String accessTokenInfo = HttpClientUtils.get(
                    WeChatLoginUtil.getUrlForAccessTokenAndOpenIdWeChat(code), "UTF-8");
            ...
            if (accessTokenInfoJson.get("access_token") != null) {
                ...
                String userInfo = HttpClientUtils.get(
                        WeChatLoginUtil.getUrlForUserInfoWeChat(accessToken, openid), "UTF-8");
    ...
    @ResponseBody
    public AjaxResult checkWeChatLoginResult(HttpServletRequest request, HttpServletResponse response,
    ...
    public String wxLoginGetCode(String code, String state,
                             HttpServletRequest request, HttpServletResponse response,
                             HttpSession session, Model model) throws Exception {
