...
<div class="container-fluid " style="margin-top: 20px">
    ...
    <div class="row">
        ...
        <div class="col-sm-10">
            <div class="row">
                <div class="col-sm-12">
                    <h1 class="page-head-line">景点管理</h1>
                </div>
            </div>
            <#setting number_format="#">
            <!--高级查询--->
            <form class="form-inline" id="searchForm" action="/scenic/list" method="post">
                <input type="hidden" name="currentPage" id="currentPage" value="1">
                <a href="/scenic/input" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span>
                    添加</a>
            </form>
            ...
            <table class="table table-striped table-hover">
               ...
               <#list pageInfo.list! as entity>
                   <tr>
                       ...
                       <td>${(entity.scenicCatalog.name)!}</td>
                       <td>${(entity.parent.name)!"顶级景点"}</td>
                       <td>${entity.visitnum!}</td>
                       <td>${entity.replynum!}</td>

                       <td>
                            <a class="btn btn-info btn-xs inputBtn" href="/scenic/input?id=${entity.id}">
