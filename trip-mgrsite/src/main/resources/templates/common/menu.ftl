<ul id="menu" class="list-group">
    ...
    <li class="list-group-item">
        ...
        <ul class="in" id="travelMgr">
            <li class="scenicCatalog"><a href="/scenicCatalog/list">景点分类管理</a></li>
            <li class="scenic"><a href="/scenic/list">景点管理</a></li>
        </ul>
    </li>
    <li class="list-group-item">
        <a href="#" data-toggle="collapse" data-target="#travelMgr">
        ...
        <ul class="in" id="travelMgr">
            <li class="ticket"><a href="/ticket/list">门票管理</a></li>
        </ul>
    </li>
    <li class="list-group-item">
        <a href="#" data-toggle="collapse" data-target="#travelMgr">
        ...
        <ul class="in" id="travelMgr">
            <li class="orderDetail"><a href="/orderDetail/list">订单管理</a></li>
        </ul>
    </li>
    <li class="list-group-item">
